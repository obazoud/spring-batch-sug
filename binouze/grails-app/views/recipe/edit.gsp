                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="fermentables"><g:message code="recipe.fermentables.label" default="Fermentables" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: recipeInstance, field: 'fermentables', 'errors')}">
                                    <g:select name="fermentables" from="${fr.sug.springbatch.binouze.domain.Fermentable.list()}" multiple="yes" optionKey="id" size="5" value="${recipeInstance?.fermentables}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="hops"><g:message code="recipe.hops.label" default="Hops" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: recipeInstance, field: 'hops', 'errors')}">
                                    <g:select name="hops" from="${fr.sug.springbatch.binouze.domain.Hop.list()}" multiple="yes" optionKey="id" size="5" value="${recipeInstance?.hops}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="miscs"><g:message code="recipe.miscs.label" default="Miscs" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: recipeInstance, field: 'miscs', 'errors')}">
                                    <g:select name="miscs" from="${fr.sug.springbatch.binouze.domain.Misc.list()}" multiple="yes" optionKey="id" size="5" value="${recipeInstance?.miscs}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="waters"><g:message code="recipe.waters.label" default="Waters" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: recipeInstance, field: 'waters', 'errors')}">
                                    <g:select name="waters" from="${fr.sug.springbatch.binouze.domain.Water.list()}" multiple="yes" optionKey="id" size="5" value="${recipeInstance?.waters}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="yeasts"><g:message code="recipe.yeasts.label" default="Yeasts" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: recipeInstance, field: 'yeasts', 'errors')}">
                                    <g:select name="yeasts" from="${fr.sug.springbatch.binouze.domain.Yeast.list()}" multiple="yes" optionKey="id" size="5" value="${recipeInstance?.yeasts}" />
                                </td>
                            </tr>
