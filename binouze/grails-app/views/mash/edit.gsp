    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${mashInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="mashSteps"><g:message code="mash.mashSteps.label" default="Mash Steps" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: mashInstance, field: 'mashSteps', 'errors')}">
                                    <g:select name="mashSteps" from="${fr.sug.springbatch.binouze.domain.MashStep.list()}" multiple="yes" optionKey="id" size="5" value="${mashInstance?.mashSteps}" />
                                </td>
                            </tr>
